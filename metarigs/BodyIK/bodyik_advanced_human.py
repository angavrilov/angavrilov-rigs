...
def create(obj):  # noqa
    ...
    add_bone_collection('Fingers (Detail)', ui_row=7, ui_title='(Detail)', color_set_id=5)
    add_bone_collection('Hands (Extra)', ui_row=8, color_set_id=6)
    add_bone_collection('Arm.L (IK)', ui_row=10, color_set_id=2)
    add_bone_collection('Arm.L (FK)', ui_row=11, ui_title='(FK)', color_set_id=5)
    add_bone_collection('Arm.L (Elbow)', ui_row=12, ui_title='(Elbow)', color_set_id=6)
    add_bone_collection('Arm.L (Tweak)', ui_row=13, ui_title='(Tweak)', color_set_id=4)
    add_bone_collection('Arm.R (IK)', ui_row=10, color_set_id=2)
    add_bone_collection('Arm.R (FK)', ui_row=11, ui_title='(FK)', color_set_id=5)
    add_bone_collection('Arm.R (Elbow)', ui_row=12, ui_title='(Elbow)', color_set_id=6)
    add_bone_collection('Arm.R (Tweak)', ui_row=13, ui_title='(Tweak)', color_set_id=4)
    add_bone_collection('Leg.L (IK)', ui_row=15, color_set_id=2)
    add_bone_collection('Leg.L (FK)', ui_row=16, ui_title='(FK)', color_set_id=5)
    add_bone_collection('Leg.L (Knee)', ui_row=17, ui_title='(Knee)', color_set_id=6)
    add_bone_collection('Leg.L (Tweak)', ui_row=18, ui_title='(Tweak)', color_set_id=4)
    add_bone_collection('Leg.R (IK)', ui_row=15, color_set_id=2)
    add_bone_collection('Leg.R (FK)', ui_row=16, ui_title='(FK)', color_set_id=5)
    add_bone_collection('Leg.R (Knee)', ui_row=17, ui_title='(Knee)', color_set_id=6)
    add_bone_collection('Leg.R (Tweak)', ui_row=18, ui_title='(Tweak)', color_set_id=4)
    ...
    assign_bone_collection_refs(pbone.rigify_parameters, 'ik_mid', 'Leg.L (Knee)')
    ...
    assign_bone_collection_refs(pbone.rigify_parameters, 'ik_mid', 'Leg.R (Knee)')
    ...
    assign_bone_collection_refs(pbone.rigify_parameters, 'ik_mid', 'Arm.L (Elbow)')
    ...
    assign_bone_collection_refs(pbone.rigify_parameters, 'ik_mid', 'Arm.R (Elbow)')
    ...
    pbone.lock_scale = (False, False, False)
    pbone.rotation_mode = 'QUATERNION'
    assign_bone_collections(pbone, 'Hands (Extra)')
    try:
    ...
    assign_bone_collection_refs(pbone.rigify_parameters, 'extra_ik', 'Hands (Extra)')
