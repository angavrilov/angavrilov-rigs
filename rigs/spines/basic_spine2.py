...
from rigify.utils.naming import strip_org, make_deformer_name, make_mechanism_name, make_derived_name
...
class Rig(BaseSpineRig):
    ...
    def initialize(self):
        ...
        self.use_fk = self.params.fk_controls
    ...
    def add_parameters(self, params):
        ...
        params.fk_controls = bpy.props.BoolProperty(
    ...
    def parameters_ui(self, layout, params):
        ...
        layout.prop(params, 'fk_controls')

        col = layout.column()
        col.active = params.fk_controls
